...
Boolean SAM_UART_Read_And_Write_Test() {
	...
	xTaskGenericCreate(taskSAM_UART_Read_And_Write_Test, (const signed char*)"UARTtest-0", 1024, (void*)&UARTtestBus[0], 2, &UART0testHandle, NULL, NULL);
	xTaskGenericCreate(taskSAM_UART_Read_And_Write_Test, (const signed char*)"UARTtest-2", 1024, (void*)&UARTtestBus[1], 2, &UART2testHandle, NULL, NULL);
