...
void taskSAM_UART_Read_Test(void *arguments) {
...
Boolean SAM_UART_Read_Test() {
	...
	*/
	...
	xTaskGenericCreate(taskSAM_UART_Read_Test, (const signed char*)"taskUARTtest-0", 1024, (void*)&UARTtestBus[0], 2, &taskUART0testHandle, NULL, NULL);
